...
const CATALOG = {
  ...
  results_not_published: [409, "Chỉ chi trả sau khi công bố kết quả."],
  award_revoked: [409, "Giải đã bị thu hồi — không chi trả."],
  award_already_paid: [409, "Giải này đã được chi trả."],
  award_no_tokens: [409, "Giải không có phần token để chi trả."],
  scores_not_final: [409, "Chỉ chốt bảng điểm sau khi công bố kết quả."],
