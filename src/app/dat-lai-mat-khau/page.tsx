...
export const metadata: Metadata = {
  title: "Đặt lại mật khẩu — Vịnh",
};

// Landed on only via the link /api/auth/confirm redirects to, after it has
// already exchanged the email's one-time code for a recovery session (see
// that route). Same split layout as /dang-nhap — see that page for why the
// panel content is hard-coded here too.
