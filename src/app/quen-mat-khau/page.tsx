...
export const metadata: Metadata = {
  title: "Quên mật khẩu — Vịnh",
};

// Same split layout as /dang-nhap (left panel is identical on purpose —
// this is a step inside the sign-in flow, not a separate section of the
