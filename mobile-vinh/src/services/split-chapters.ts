// COPY of src/lib/authoring/split-chapters.ts (Metro cannot import web source at runtime).
// Keep identical; scripts/test-authoring.cjs checks both give the same result on sample manuscripts.
